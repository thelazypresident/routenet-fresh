...
export default function FinanceData() {
  const { theme, user, formatCurrency } = useApp();
  ...
  const { data: transactions = [] } = useQuery({
    queryKey: ['finance-data-transactions', startDate, endDateExclusive],
    queryFn: async () => {
  ...
  const categoryNames = {
    ...
    permit: 'Permit',
    drivers_license_renewal: "Driver's License",
          ...
          <div className="space-y-1">
            <div className="flex justify-center mt-2 mb-1">
              <span className="stat-card-income text-white px-4 py-2.5 rounded-lg flex items-center">
                <span className="text-[10px] font-semibold uppercase">GROSS INCOME = </span>
            ...
            <div className="pt-1 pb-2 px-6">
              <ResponsiveContainer width="100%" height={280}>
                <PieChart>
                  <Pie
                    data={[
                      { name: 'Expenses', value: totalExpenses, color: '#EF5350' },
                      { name: 'Net Income', value: Math.max(0, netIncome), color: '#66BB6A' }
                    ]}
                    cx="50%"
                    cy="50%"
                    innerRadius={70}
              ...
              <div className="flex flex-col items-center gap-2 mt-2">
                <div className="flex items-center gap-2">
                  <span className="stat-card-expense text-white px-4 py-2.5 rounded-lg flex items-center">
                    <span className="text-[10px] font-semibold uppercase">EXPENSES = </span>
                ...
                <div className="flex items-center gap-2">
                  <span className="stat-card-net text-white px-4 py-2.5 rounded-lg flex items-center">
                    <span className="text-[10px] font-semibold uppercase">NET INCOME = </span>
